...
public class OrderItemDetail : IMapFrom<OrderItem>
{
    ...
    public decimal LineTotal { get; set; } // Entity'deki hesaplanmış alan
    ...
    {
        profile.CreateMap<OrderItem, OrderItemDetail>()
