        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DarkMode_Enabled = table.Column<bool>(type: "bit", nullable: true),
                    DarkMode_Background = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DarkMode_Surface = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DarkMode_Text = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomFieldDef", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnabledModulesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MenuOrderJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefaultFieldsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantSettings_Branding_BrandingId",
                        column: x => x.BrandingId,
                        principalSchema: "Preset",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQty = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RoleId,
                        principalSchema: "RoleAssignment",
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryMove", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryMove_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryMove_ProductId",
                schema: "InventoryMoves",
                table: "InventoryMove",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantSettings_BrandingId",
                schema: "Preset",
